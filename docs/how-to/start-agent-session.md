...
This guide shows you how to start an AI-assisted development session using OpenCode.
...
1. Validates the current presentation (auto-selects `example` if invalid)
